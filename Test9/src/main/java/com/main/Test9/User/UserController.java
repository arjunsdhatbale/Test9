...
// Head Method
    ...
    public ResponseEntity<Void> checkUserExist(@Parameter(description = "User Id to test HEAD method.") @PathVariable("id")Integer id){
    ...
    @GetMapping("/{id}")
    public ResponseEntity<UserMaster> getUser(@Valid @PathVariable ("id") Integer id) throws UserNotFoundException {
